...
<img src="https://raw.githubusercontent.com/iurman/iurman/main/assets/banner-night-sky.svg" alt="Isaac Urman, product engineer and team lead" width="100%">
...
I lead a team of 15+ engineers at Tasty LLC building an enterprise CRM that 1,000+ people use. I
designed the architecture and I still write a lot of the code.

I like the unglamorous middle of software (data migrations, invoicing edge cases, deploy pipelines)
because that's usually where products live or die. On the side I'm building
[ResuPals](https://resupals.com), a resume builder you can use without making an account.

After hours I run a Proxmox homelab and the game server hosting business I started in 2018. Real
customers, real monitoring, real 3 a.m. alerts.

I also play about 20 different instruments.

### Projects

| Project | What it is | Stack |
| :-- | :-- | :-- |
| **[ResuPals](https://resupals.com)** &#183; [code](https://github.com/iurman/resupals) | ATS-optimized resume and cover letter builder. Guest mode keeps everything in your browser with no account and nothing sent to a server. Sign in and documents sync to your own private cloud. | `Next.js` `TypeScript` `Cloudflare Workers` `D1` `TipTap` |
...
| **[Homelab](https://isaacurman.com/projects/homelab-infrastructure)** | Proxmox, TrueNAS, and Tailscale, with Prometheus and Grafana watching all of it. Runs my projects and paying game server customers. | `Proxmox` `TrueNAS` `Tailscale` `Grafana` |
